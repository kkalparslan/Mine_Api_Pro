...
public class KraftechUser {
    ...
    public String toString() {
        ...
        sb.append(KraftechUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
